...
class Login:
  ...
  def __putFile(self, pc):
    ...
    try:
      ...
      print "putFile [%s] to [%s] error." %(self.localFile, pc)
  ...
  def putFileToPC(self, localFile, remoteFile, pc):
    ...
    try:
      ...
      print "putFile [%s] to [%s] error." %(localFile, pc)
  ...
  def getFile(self, remoteFile, localFile=None):
    global login_pclist
    self.localFile  = localFile
    self.remoteFile = remoteFile
    self.startWork(self.__getFile, login_pclist)
